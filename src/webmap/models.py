...
class Status(models.Model):
    "Status of a given object, layer, ect. - active, proposed, deleted..."
...
class Layer(models.Model):
    "A map layer, either a BaseLayer or an OverlayLayer"
...
class Marker(models.Model):
    ...
    default_icon_height = models.IntegerField(default=20, verbose_name=_("default icon height"))
    default_icon_width = models.IntegerField(default=20, verbose_name=_("default icon width"))
    ...
    maxzoom = models.PositiveIntegerField(default=10, verbose_name=_("Maximum zoom"), help_text=_(u"Maximum zoom in which the POIs of this marker will be shown on the map."))
...
class Legend(models.Model):
    ...
    en_name = models.CharField(unique=True, max_length=255, null=True, blank=True, verbose_name=_(u"English name (depricated)"))
    slug = models.SlugField(unique=True, verbose_name=_(u"name in URL"))
    desc = models.TextField(null=True, blank=True, verbose_name=_(u"description"))
    image = models.ImageField(upload_to='icons', storage=SlugifyFileSystemStorage(), verbose_name=_(u"image"))
...
class BaseLayer(Layer):
    ...
    url = models.CharField(
        ...
        blank=True,
        verbose_name=_("URL"),
        help_text=_(u"Base layer tiles url. e.g. "),
        max_length=255,
    )
...
class MapPreset(models.Model):
    ...
    slug = models.SlugField(unique=True, verbose_name=_(u"name in URL"), default='')
